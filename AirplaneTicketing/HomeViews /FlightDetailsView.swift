...
struct FlightDetailsView: View {
    ...
    var body: some View {
            ...
            Toggle(isOn: $roundTrip) {
                ...
                VStack {
                    HStack {
                        ...
                        DatePicker("", selection: $fromDate, in: roundTrip ? ...toDate :
                                    ...Date().addingTimeInterval(3600*24*365),
        ...
        NavigationLink(
            destination: CalculatedRoute( desrinationFrom: destinationFrom, destinationTo: destinationTo, roundTrip: $roundTrip, fromDate: $fromDate, toDate: $toDate, countOassengers: $countPassengers, cabinClass: $cabinClass),label: {
                HStack {
                    Text("Search Flights")
...
struct FlightDetailsView_Previews: PreviewProvider {
    static var previews: some View {
        FlightDetailsView(destinationFrom: "London", destinationTo: "Paris")
    }
}
